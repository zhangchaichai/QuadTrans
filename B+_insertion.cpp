...
#ifndef QUADTRANS_B__INSERTION_CPP
#define QUADTRANS_B__INSERTION_CPP

#include <algorithm>
#include "B+ tree.h"

void BPTree::insert(int key, Leaf filePtr) {  //in Leaf Node
    /*
	...
	*/
    if (root == NULL) {
        ...
        //  cout<<"len:"<<root->ptr2TreeOrData.dataPtr[0].len<<endl;
        ...
        if (cursor->keys.size() < maxLeafNodeLimit) {
			...
			*/
            ...
            vector<Leaf> virtualDataNode(cursor->ptr2TreeOrData.dataPtr);
...
#endif //QUADTRANS_B__INSERTION_CPP
